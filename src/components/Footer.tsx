      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              {['instagram', 'twitter', 'facebook'].map((social) => (
                <a
                  key={social}
                  href={`https://${social}.com/exploredfw`}
                  className="w-9 h-9 rounded-full bg-ink-800 hover:bg-ink-700 flex items-center justify-center transition-colors"
                  aria-label={social}
                >
                  {social === 'instagram' && (
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/guides" className="text-ink-300 hover:text-white transition-colors text-sm">
                  City Guides
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-ink-300 hover:text-white transition-colors text-sm">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/newsletter" className="text-ink-300 hover:text-white transition-colors text-sm">
                  Newsletter
                </Link>
              </li>
              <li>
                <Link href="/app" className="text-ink-300 hover:text-white transition-colors text-sm">
                  Mobile App
                </Link>
              </li>
            </ul>
